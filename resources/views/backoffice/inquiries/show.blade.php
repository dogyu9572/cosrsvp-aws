        ...
        <div class="board-card">
            <div class="board-card-body">
                ...
                <div class="board-form-group" style="margin-bottom: 10px;">
                    <label class="board-form-label" style="margin-bottom: 10px;">문의 회원 정보</label>
                    <div class="board-form-row">
                        <div class="board-form-col">
                            <div class="board-form-group" style="margin-bottom: 8px;">
                ...
                <div class="board-form-group" style="margin-bottom: 10px;">
                    ...
                    <textarea class="board-form-control board-form-textarea" rows="8" readonly>{{ $inquiry->content }}</textarea>
                </div>
