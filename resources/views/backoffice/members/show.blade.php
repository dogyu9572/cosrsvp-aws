                            ...
                            <div class="board-form-col">
                                <div class="board-form-group">
                                    ...
                                    <select id="project_term_id" name="project_term_id" class="board-form-control" required tabindex="1">
                                        ...
                                        @foreach(\App\Models\ProjectTerm::active()->orderBy('display_order')->get() as $term)
                    ...
                    <div class="board-form-row">
                        <div class="board-form-col">
                            <div class="board-form-group">
                                ...
                                <input type="text" id="login_id" value="{{ $member->login_id }}" class="board-form-control" readonly tabindex="6">
                            </div>
                            <div class="board-form-group">
                                <label for="password" class="board-form-label">비밀번호</label>
                                <form action="{{ route('backoffice.members.reset-password', $member) }}" method="POST" class="d-inline">
                                    @csrf
                                    <button type="submit" class="btn btn-warning btn-sm" onclick="return confirm('비밀번호를 초기화하시겠습니까? (기본 비밀번호: COS1234)');" tabindex="9">
                                        초기화
                                    </button>
                                </form>
                            </div>
