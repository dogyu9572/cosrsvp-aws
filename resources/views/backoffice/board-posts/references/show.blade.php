    ...
    <div class="board-container">
        <div class="board-page-header">
            <div class="board-page-buttons">
                <a href="{{ route('backoffice.board-posts.index', $board->slug ?? 'faq') }}" class="btn btn-secondary btn-sm">
        ...
        <div class="board-card">
            <div class="board-card-body">
                ...
                <div class="board-post-actions">
                    <a href="{{ route('backoffice.board-posts.edit', [$board->slug ?? 'faq', $post->id]) }}" class="btn btn-primary">
                        <i class="fas fa-edit"></i> 수정
                    </a>
                    <form action="{{ route('backoffice.board-posts.destroy', [$board->slug ?? 'faq', $post->id]) }}" 
