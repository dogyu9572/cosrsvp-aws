    ...
    <div class="board-container">
        <div class="board-page-header">
            <div class="board-page-buttons">
                ...
                <a href="{{ route('backoffice.board-posts.create', $board->slug ?? 'top-notices') }}" class="btn btn-success">
        ...
        <div class="board-card">
            <div class="board-card-body">
                ...
                <div class="board-filter">
                    <form method="GET" action="{{ route('backoffice.board-posts.index', $board->slug ?? 'top-notices') }}" class="filter-form" id="filterForm">
                        <!-- 프로젝트 기수 필터 -->
                        ...
                        <div class="filter-row">
                            ...
                            <div class="filter-group">
                                ...
                                <input type="text" id="keyword" name="keyword" class="filter-input"
                                    placeholder="내용을 입력하세요" value="{{ request('keyword') }}">
                            ...
                            <div class="filter-group">
                                <div class="filter-buttons">
                                    ...
                                    <a href="{{ route('backoffice.board-posts.index', $board->slug ?? 'top-notices') }}"
                ...
                <div class="board-list-header">
                    ...
                    <div class="list-controls">
                        <form method="GET" action="{{ route('backoffice.board-posts.index', $board->slug ?? 'top-notices') }}" class="per-page-form">
                                ...
                                <tr @if($board->enable_sorting) data-post-id="{{ $post->id }}" @endif>
                                    ...
                                    <td>
                                        <div class="board-btn-group">
                                            <a href="{{ route('backoffice.board-posts.edit', [$board->slug ?? 'top-notices', $post->id]) }}"
                                                class="btn btn-primary btn-sm">
                                                <i class="fas fa-edit"></i> 수정
                                            </a>
                                            <form
                                                action="{{ route('backoffice.board-posts.destroy', [$board->slug ?? 'top-notices', $post->id]) }}"
